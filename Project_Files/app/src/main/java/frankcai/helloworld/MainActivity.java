...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int COUNTER = 1;            // "+" or "-" button increment with 1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextView.setText("Update Value: Move the Bar OR Click the Button");             // Set text
